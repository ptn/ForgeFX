...
import {
  FM3_RANGES_CLASSIFIED as FM3_RANGES,
...
import {
  ...
  AXE3_ENUM_OVERRIDES, AXE3_RANGES_CLASSIFIED as AXE3_DEVICE_RANGES, AXE3_CAB_IRS,
  AXE3_MONITOR_PARAMS,
...
import type { DeviceEditorLayouts } from 'forgefx-midi/gen3/fm3';
import { layoutFrom, type DeviceLayout, type SelectorValues } from './layouts.js';
export { am4LayoutFor, resolveLayoutPages, type DeviceLayout, type SelectorValues } from './layouts.js';
